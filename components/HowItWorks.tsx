    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#1C1C1C] mb-4">The Process</h2>
          <p className="text-xl text-gray-500">From raw timber to your kitchen counter.</p>
        </div>

        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {steps.map((s, i) => (
            <div key={s.step} className="relative bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
              <div className="w-16 h-16 bg-amber-50 rounded-2xl flex items-center justify-center mb-6">
                <s.icon className="w-8 h-8 text-amber-700" />
              </div>
              <div className="text-xs font-bold text-amber-600 mb-2">STEP {s.step}</div>
